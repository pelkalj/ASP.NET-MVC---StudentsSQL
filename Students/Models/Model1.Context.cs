...
namespace Students.Models
{
    ...
    public partial class Praksa_Nov_2019Entities : DbContext
    {
        ...
        public virtual DbSet<Ocjena_Pelka> Ocjena_Pelka { get; set; }
        public virtual DbSet<UpisStudenataNaPredmet_Pelka> UpisStudenataNaPredmet_Pelka { get; set; }
    
        public virtual int InsertZaduzenjaNata(Nullable<System.Guid> idPredmeta, Nullable<System.Guid> idProfesora, Nullable<System.Guid> idAsistenta)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertZaduzenjaNata", idPredmetaParameter, idProfesoraParameter, idAsistentaParameter);
        }
        ...
        public virtual int UnosProfesora_Dragana(Nullable<System.Guid> iDPredmeta, Nullable<System.Guid> iDProfesora, string zaduzenje)
        {
            var iDPredmetaParameter = iDPredmeta.HasValue ?
                new ObjectParameter("IDPredmeta", iDPredmeta) :
                new ObjectParameter("IDPredmeta", typeof(System.Guid));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UnosProfesora_Dragana", iDPredmetaParameter, iDProfesoraParameter, zaduzenjeParameter);
        }
        ...
        public virtual int ZaduzenjeProfesoraProcedura(Nullable<int> iDPredmeta, Nullable<int> iDProfesora, Nullable<int> asistenta)
        {
            var iDPredmetaParameter = iDPredmeta.HasValue ?
                new ObjectParameter("IDPredmeta", iDPredmeta) :
                new ObjectParameter("IDPredmeta", typeof(int));
            ...
            var asistentaParameter = asistenta.HasValue ?
                new ObjectParameter("Asistenta", asistenta) :
                new ObjectParameter("Asistenta", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ZaduzenjeProfesoraProcedura", iDPredmetaParameter, iDProfesoraParameter, asistentaParameter);
        }
    }
}
